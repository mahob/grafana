...
const operatorOptions: SelectableValue<KnownOperator>[] = knownOperators.map(makeSimpleOption);
const condititonOptions: SelectableValue<KnownCondition>[] = knownConditions.map(makeSimpleOption);
